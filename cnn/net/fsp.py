...
class Model(nn.Module):
    def __init__(self, img_size=384):
        ...
        self.reduce1 = Conv1x1(256, 192)
        self.reduce2 = Conv1x1(512, 192)
        self.reduce3 = Conv1x1(1024, 192)
        self.reduce4 = Conv1x1(2048, 192)
    ...
    def forward(self, x4, x3, x2, x1):
        ...
        out1 = F.interpolate(out1, (544, 544), mode='bilinear', align_corners=False)
        out2 = F.interpolate(out2, (544, 544), mode='bilinear', align_corners=False)
        out3 = F.interpolate(out3, (544, 544), mode='bilinear', align_corners=False)
        out4 = F.interpolate(out4, (8, 8), mode='bilinear', align_corners=False)
